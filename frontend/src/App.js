  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-blue-900">My Habits</h1>
        <button
      ...
      {showCreateForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white border border-blue-200 rounded-lg p-6 w-full max-w-md">
            <h2 className="text-xl font-bold text-blue-900 mb-4">Create New Habit</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {habits.map((habit) => (
          <div key={habit.id} className="bg-white border border-blue-200 rounded-lg shadow-sm p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center">
                <span className="text-2xl mr-3">{categoryEmojis[habit.category]}</span>
                <div>
                  <h3 className="font-semibold text-blue-900">{habit.name}</h3>
                  <p className="text-sm text-blue-700 capitalize">{habit.category.replace('_', ' ')}</p>
                </div>
              </div>
              <div className="text-right">
                <div className="text-sm text-blue-600">Streak</div>
                <div className="text-xl font-bold text-blue-700">{habit.current_streak}</div>
              </div>
            </div>
            
            {habit.description && (
              <p className="text-sm text-blue-700 mb-4">{habit.description}</p>
            )}
      ...
      {habits.length === 0 && (
        <div className="text-center py-12 bg-white border border-blue-200 rounded-lg">
          <div className="text-6xl mb-4">🎯</div>
          <h3 className="text-xl font-semibold text-blue-900 mb-2">No habits yet</h3>
          <p className="text-blue-700 mb-6">Create your first habit to start building a better you!</p>
          <button
            onClick={() => setShowCreateForm(true)}
